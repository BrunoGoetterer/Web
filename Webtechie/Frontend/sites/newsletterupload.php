          ...
          <div class="col-12 col-md-8 col-lg-6 col-xl-5">
            <div class="card bg-transparent text-white" style="border-radius: 0rem;">
              <div class="card-body p-5 text-center">
                ...
                <form method="POST" action='../../Backend/config/insert_newsletter.php' enctype="multipart/form-data">
                  <?php
                  ...
                  <div class="mb-4 text-black">
                    ...
                    <select name="tags" id="tags" class="form-select">
                      <option value="Sport">Lego Technic</option>
                      <option value="Wellness">Lego Heroes</option>
                      <option value="Kultur">Lego Classic</option>
                      <option value="Kultur">Lego Disney</option>
                      <option value="Kultur">Lego City</option>
                    </select>
                  </div>
                  <div class="mb-4 text-black">
